...
<div class="flex flex-col items-center justify-center gap-6 h-full text-center">
  ...
  <div class="leading-none" 
    ...
    <span class="mono font-black text-white" style="font-size: 8rem; line-height: 1;">100M</span><span class="mono font-black" style="font-size: 8rem; line-height: 1; color: #FF2302;">+</span>
  </div>

  <p class="text-2xl" style="color: rgba(255,255,255,0.5);"
  ...
  <div class="mt-4 px-10 py-5 card"
    ...
    <p class="mono text-xl" style="color: rgba(255,255,255,0.8);">
