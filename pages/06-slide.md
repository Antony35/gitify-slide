...
<div class="flex flex-col items-center justify-center gap-2 h-full">
  ...
  <p class="mono text-xs tracking-widest uppercase mb-4 dim-25" 
...
<div class="flex flex-col items-center gap-0">
  ...
  <div class="card px-8 py-3 text-center" style="min-width: 260px;"
    ...
    <p class="mono text-sm font-semibold text-mint">Tes préférences</p>
    <p class="text-xs mt-1 dim-35">langages · niveau · type de projets</p>
  </div>
  
  <!-- Flèche 1 -->
  <div class="flex flex-col items-center dim-20" style="gap: 0"
  ...
  <div class="flex items-center gap-3"
    ...
    <div class="card px-8 py-3 text-center" style="min-width: 260px;">
      ...
      <p class="text-xs mt-1 dim-35">lazy-fetch si stock &lt; 25 projets</p>
    </div>
  </div>
  ...
  <div class="flex flex-col items-center"
    ...
    <div style="width:1px; height:16px; background: rgba(255,255,255,0.15);"></div>
    <span class="dim-20" style="font-size: 10px">▼</span>
  </div>
  ...
  <div class="px-8 py-4 text-center rounded-xl" style="min-width: 260px; background: rgba(166,240,211,0.05); border: 1px solid rgba(166,240,211,0.2);"
    ...
    <p class="mono text-xs font-bold mb-2 text-mint" style="letter-spacing: 0.1em">CACHE</p>
    <div class="flex justify-center gap-6">
      <div>
        <p class="mono text-sm font-semibold text-white">24h</p>
        <p class="text-xs dim-35">liste de repos</p>
      </div>
      <div style="width:1px; background: rgba(255,255,255,0.1);"></div>
      <div>
        <p class="mono text-sm font-semibold text-white">7j</p>
        <p class="text-xs dim-35">détails d'un repo</p>
      </div>
    </div>
  </div>
  ...
  <div class="card px-8 py-3 text-center" style="min-width: 260px;"
    ...
    <p class="text-xs mt-1 dim-35">équité entre TypeScript, Python, Rust…</p>
  </div>
  ...
  <div class="px-8 py-3 text-center rounded-xl" style="min-width: 260px; background: rgba(255,35,2,0.08); border: 1px solid rgba(255,35,2,0.3);"
    ...
    <p class="mono text-sm font-bold text-red">Ton feed ✓</p>
  </div>
