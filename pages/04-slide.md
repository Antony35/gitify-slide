...
<div class="flex flex-col items-center justify-center gap-8 h-full">
  ...
  <div class="card flex flex-col items-center gap-3 px-6 py-5 w-36">
    <div class="w-12 h-12 rounded-full flex items-center justify-center mono font-bold text-sm text-mint" style="background: rgba(166,240,211,0.1); border: 1px solid rgba(166,240,211,0.25)"
    ...
    <div class="text-center">
        ...
        <p class="mono text-xs mt-1 text-mint"
  ...
  <!-- Théo -->
  <div class="card flex flex-col items-center gap-3 px-6 py-5 w-36">
    <div class="w-12 h-12 rounded-full flex items-center justify-center mono font-bold text-sm text-red" style="background: rgba(255,35,2,0.1); border: 1px solid rgba(255,35,2,0.25)"
    ...
    <div class="text-center">
        ...
        <p class="mono text-xs mt-1 text-red"
