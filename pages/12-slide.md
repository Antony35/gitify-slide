...
<div class="flex flex-col items-center justify-center gap-10 h-full text-center">
  ...
  <div class="flex flex-col gap-2" 
    ...
    <p class="mono text-sm dim-30">en direct</p>
  </div>
  ...
  <div class="flex flex-col gap-3" style="width: 440px;">
    <div class="flex items-center gap-3 px-5 py-3 card rounded-xl"
      ...
      <span class="mono text-xs font-bold text-mint">01</span>
  ...
  <div class="flex items-center gap-3 px-5 py-3 card rounded-xl"
      ...
      <span class="mono text-xs font-bold text-mint">02</span>
  ...
  <div class="flex items-center gap-3 px-5 py-3 card rounded-xl"
      ...
      <span class="mono text-xs font-bold text-mint">03</span>
